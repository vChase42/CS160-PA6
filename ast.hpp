...
public:
  ...
  virtual void visitQMNode(QMNode* node) = 0;
...
// AST Node for QM
class QMNode : public ExpressionNode {
public:
  virtual void visit_children(Visitor* v);
  virtual void accept(Visitor* v) { v->visitQMNode(this); }

  ExpressionNode* expression_1;
  ExpressionNode* expression_2;
  ExpressionNode* expression_3;

  QMNode(ExpressionNode* expression_1, ExpressionNode* expression_2, ExpressionNode* expression_3);
};
...
public:
  ...
  virtual void visitQMNode(QMNode* node);
