...
// Visit Children method for QM AST node
void QMNode::visit_children(Visitor* v) {
  expression_1->accept(v);
  expression_2->accept(v);
  expression_3->accept(v);
}

// Constructor for QM AST node
QMNode::QMNode(ExpressionNode*  expression_1, ExpressionNode*  expression_2, ExpressionNode*  expression_3) {
  this->expression_1 = expression_1;
  this->expression_2 = expression_2;
  this->expression_3 = expression_3;
}
...
// Concrete visit function for QM nodes
void Print::visitQMNode(QMNode* node) {
  this->pushLevel("QM");
  node->visit_children(this);
  this->popLevel();
}
